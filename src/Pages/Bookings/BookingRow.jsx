...
const BookingRow = ({ booking, handleDelete, handleUpdateConfirm }) => {
  ...
  return (
    <tr>
      ...
      <td>${price}</td>
      <th>
       { status === 'confirm' ? <span className="text-blue-600">Confirmed</span> : <button onClick={() => handleUpdateConfirm(_id)} className="btn btn-primary btn-xs">Please Confirm</button>}
      </th>
    </tr>
  );
};
